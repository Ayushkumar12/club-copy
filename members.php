...
<html lang="en">
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="text-gray-500 bg-red" style="backdrop-filter: blur(20px)">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Anmol3.webp" alt="Bonnie Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
                  <a href="#">Mr. Anmol Kumar</a>
              </h3>
              <p>founder</p>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Ankit.jpg" alt="Helene Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
                  <a href="#">Ankit Chauhan</a>
              </h3>
              <p>Core Member</p>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Himadri.webp" alt="Jese Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
                  <a href="#">Himadri Shahi</a>
              </h3>
              <p>Core member</p>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Kuldeep.webp" alt="Joseph Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
                  <a href="#">Kuldeep Singh</a>
              </h3>
              <p>Core member</p>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Anjali.webp" alt="Sofia Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
                  <a href="#">Anjali Yadav</a>
              </h3>
              <p>Core Member</p>
              <ul class="flex justify-center mt-4 space-x-4">
                  <li>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full object-cover" src="assets/member/Ayush1.webp" alt="Leslie Avatar">
              <h3 class="mb-1 font-poppins text-2xl font-bold tracking-tight text-white">
